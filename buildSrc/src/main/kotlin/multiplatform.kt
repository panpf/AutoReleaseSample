...
fun Project.applyKotlinJsImplicitDependencyWorkaround() {
    tasks {
        val configureJs: Task.() -> Unit = {
            ...
            dependsOn(getByPath(":library-core:jsDevelopmentLibraryCompileSync"))
            dependsOn(getByPath(":library-core:jsDevelopmentExecutableCompileSync"))
            dependsOn(getByPath(":library-core:jsProductionLibraryCompileSync"))
            dependsOn(getByPath(":library-core:jsProductionExecutableCompileSync"))
            dependsOn(getByPath(":library-core:jsTestTestDevelopmentExecutableCompileSync"))
        }
...
fun Project.applyKotlinWasmJsImplicitDependencyWorkaround() {
    tasks {
        val configureWasmJs: Task.() -> Unit = {
            ...
            dependsOn(getByPath(":library-core:wasmJsDevelopmentLibraryCompileSync"))
            dependsOn(getByPath(":library-core:wasmJsDevelopmentExecutableCompileSync"))
            dependsOn(getByPath(":library-core:wasmJsProductionLibraryCompileSync"))
            dependsOn(getByPath(":library-core:wasmJsProductionExecutableCompileSync"))
            dependsOn(getByPath(":library-core:wasmJsTestTestDevelopmentExecutableCompileSync"))
        }
